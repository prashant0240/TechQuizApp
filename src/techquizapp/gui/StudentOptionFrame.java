...
public class StudentOptionFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jrTakeTest.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jrTakeTest.setForeground(new java.awt.Color(255, 0, 51));
        jrTakeTest.setText("Take Test");

        jrChangePass.setBackground(new java.awt.Color(0, 0, 0));
        jrChangePass.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jrChangePass.setForeground(new java.awt.Color(255, 0, 51));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\LENOVO\\Documents\\NetBeansProjects\\TechQuizApp\\src\\techquizapp\\gui\\stud1.jpg")); // NOI18N
        jLabel6.setText("jLabel3");

        jrViewScore.setBackground(new java.awt.Color(0, 0, 0));
        jrViewScore.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jrViewScore.setForeground(new java.awt.Color(255, 0, 51));
    ...
    private boolean validateInputs(){
        if(jrTakeTest.isSelected()==false && jrViewScore.isSelected()==false && jrChangePass.isSelected()==false)
            return false;
        return true;
    }
    private void btnDoTaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoTaskActionPerformed
        if(validateInputs()==false){
            JOptionPane.showMessageDialog(null,"Palese make a selection","Error",JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        else if(jrViewScore.isSelected())
        {
            ...
            ViewScoreFrame registerFrame=new ViewScoreFrame();
            registerFrame.setVisible(true);
            this.dispose();
        }
        else if(jrChangePass.isSelected())
        {
            ChangePasswordFrame scoresFrame=new ChangePasswordFrame();
